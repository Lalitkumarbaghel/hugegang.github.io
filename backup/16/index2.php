	...
	<div id="likes" class="tabcontent2" style="display: block;">
	  ...
	  <div class="ontouch_div">
		...
		<div class="inner_animation_div" id="inner_animation_div">
			<div class="ontouch_move_inner_height">
			...
			<div class="ontouch_btm_btn inner_btns_position">
				<ul>
					<li>
						<button><span class="flaticon-close"></span></button>
					</li>
				...
				<div class="account_setting range_cntnt">
					<div class="setting_cntnt">
						<div class="huge-row">
							...
							<div class="huge-12">
								<div class="slidecontainer">
								  <input type="range" min="1" max="60" value="8"  class="rangeslider" id="myRange2">
								</div>
								<script>
									var slider3 = document.getElementById("myRange2");
									var output2 = document.getElementById("distance_range2");
